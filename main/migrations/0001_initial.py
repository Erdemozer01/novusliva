    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated At')),
                ('status', models.CharField(choices=[('cart', 'In Cart'), ('pending', 'Payment Pending'), ('pending_iyzico_approval', 'Pending Iyzico Approval'), ('pending_paytr_approval', 'Pending PayTR Approval'), ('completed', 'Completed'), ('payment_failed', 'Payment Failed'), ('cancelled', 'Cancelled')], default='cart', max_length=30, verbose_name='Status')),
                ...
                ('identity_number', models.CharField(blank=True, max_length=11, null=True, verbose_name='Identity Number')),
